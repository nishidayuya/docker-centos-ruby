...
# https://github.com/docker-library/ruby/blob/fc6fd1e86d41ca7efa2737374ca12f73c3bc42ac/update.sh
...
for version in "${versions[@]}"; do
	...
	; do
		...
		case "$variant" in
			...
			centos7) template="$variant"; tag="$variant" ;;
		...
		sed -r \
			...
			-e 's!^(FROM (centos|nishidayuya/centos-buildpack-deps)):.*!\1:'"$tag"'!' \
